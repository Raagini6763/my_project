  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Text style={styles.body}>CitznY processes story text, optional contact email, selected category and location description, and any photos or videos that you choose to upload.</Text>
        ...
        <Text style={styles.body}>Camera and photo access is requested only when you use the corresponding story feature. You may deny these permissions. To request correction or deletion of a submitted story, contact the CitznY administrator using the developer contact shown on the Play Store listing.</Text>
